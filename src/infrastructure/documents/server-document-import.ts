...
import { ImportDocuments, type DocumentImportLoggerPort } from "@/application/documents/import-documents";
...
const logger: DocumentImportLoggerPort = {
  event(event) {
...
export const importDocuments = new ImportDocuments(
  ...
  new LocalDocumentExtractor(new LocalPdfOcr({ logger })),
